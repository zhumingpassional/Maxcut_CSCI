...
Some results are denoted by strings. Take data/syn/powerlaw_100_ID0.txt (using L2A) as an example, the result is "4SuqhIaQimYjyk_sX", which can be transferred to digits by calling the function str_to_bool in EncoderBase64 in evaluator.py. 
